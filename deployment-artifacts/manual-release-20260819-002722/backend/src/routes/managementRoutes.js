...
router.post('/visit-quota/add', allowRoles('super_admin'), controller.addVisitQuota);
router.put('/visit-quota/base', allowRoles('super_admin'), controller.updateVisitQuotaBase);
router.get('/visit-quotas', allowRoles('super_admin'), controller.getVisitQuotas);
router.post('/visit-quotas/add', allowRoles('super_admin'), controller.addVisitQuota);
router.put('/visit-quotas/base', allowRoles('super_admin'), controller.updateVisitQuotaBase);
router.put('/visit-quotas/per-employee', allowRoles('super_admin'), controller.updateVisitQuotaPerEmployee);
